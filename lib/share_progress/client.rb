...
module ShareProgress
  class Client
    ...
    base_uri ShareProgress.configuration.share_progress_uri || 'run.shareprogress.org/api/v1'
    default_params key: ShareProgress.configuration.share_progress_api_key || ENV['SHARE_PROGRESS_API_KEY']
